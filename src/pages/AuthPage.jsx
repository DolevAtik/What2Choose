      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel p-6 animate-fade-up !rounded-3xl border-t border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
          ...
          <button
            ...
            className="btn-secondary w-full py-4 text-sm font-bold tracking-wide flex items-center justify-center gap-3 border-white/10 hover:border-white/20 hover:bg-surface"
          >
